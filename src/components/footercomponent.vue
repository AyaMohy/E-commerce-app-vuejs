<template>
    <div class="mx-5 my-5 py-5 border-top">
        <!-- footercomponent -->
        <h3>E-Commerce App </h3>
        <section class="row mx-auto">
            <div class="col-12 col-sm-9 col-md-6">
                <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Qui odit porro accusantium consequuntur ipsum, at ad, cumque itaque quae non debitis nihil possimus, recusandae a odio assumenda suscipit dolorem iusto?</p>
                <div>
                    <a href="#" class="btn rounded-circle bg-primary p-2" target="_blink">
                    ...
                    <a href="#" class="btn rounded-circle bg-info mx-3 p-2" target="_blink">
                    ...
                    <a href="#" class="btn rounded-circle p-2 bg-danger bg-gradient" target="_blink">
            ...
            <!-- right  -->
            <div class=" ps-5 col-12 col-sm-9 col-md-6">
                <div class="mb-3">
                    ...
                    <span class="ps-3">State Of Egypt</span>
                </div>
                <div class="mb-3">
                    ...
                    <span class="ps-3">+203456789</span>
                </div>
                 <div>
                    ...
                    <span class="ps-3">aya.mohey162@gmail.com</span>
                </div>
            </div>
        </section>
    </div>
